...
export const setupScrollAnimations = () => {
    ...
    pinAndAnimate({
        ...
        animations: [
            ...
            { target: ".shine1", vars: { opacity: 1 }, position: 0.4 },
            { target: ".shine2", vars: { opacity: 1 }, position: 0.6 },
            { target: ".shine3", vars: { opacity: 1 }, position: 0.8 },
            ...
            { target: ".flash1", vars: { opacity: 1 }, position: 1.2 },
            { target: ".boom1", vars: { opacity: 1 }, position: 1.4 },
            { target: ".flash2", vars: { opacity: 1 }, position: 1.6 },
            { target: ".boom2", vars: { opacity: 1 }, position: 1.8 },
            {
                target: ".story__text1",
                vars: { opacity: 1 },
                position: 2,
            ...
            { target: ".bigstar", vars: { opacity: 1 }, position: 3.5 },
            { target: ".m", vars: { opacity: 1 }, position: 3.5 },
            { target: ".whut1", vars: { opacity: 1 }, position: 3.5 },
            { target: ".whut2", vars: { opacity: 1 }, position: 3.7 },
            { target: ".whut3", vars: { opacity: 1 }, position: 3.9 },
            {
                target: ".story__text2",
                vars: { opacity: 1 },
                position: 4,
            ...
            { target: ".wauw1", vars: { opacity: 1 }, position: 5.8 },
            { target: ".wauw2", vars: { opacity: 1 }, position: 6.1 },
            { target: ".wauw3", vars: { opacity: 1 }, position: 6.4 },
            {
                target: ".story__text3",
                vars: { opacity: 1 },
                position: 6.5,
