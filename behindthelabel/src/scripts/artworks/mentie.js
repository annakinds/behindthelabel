...
export const setupScrollAnimations = () => {
    ...
    pinAndAnimate({
        ...
        animations: [
            ...
            { target: ".milan", vars: { opacity: 1 }, position: 0.2 },
            { target: ".milan__text", vars: { opacity: 1 }, position: 0.2 },
            { target: ".trophy", vars: { rotate:"-20deg" }, position: 0.5 },
            { target: ".winner", vars: { rotate: "-20deg" }, position: 0.5 },
            { target: ".liège", vars: { opacity: 1 }, position: 0.5 },
            { target: ".liège__text", vars: { opacity: 1 }, position: 0.5 },
            { target: ".trophy", vars: { rotate: "0deg" }, position: 0.8 },
            { target: ".winner", vars: { rotate: "0deg" }, position: 0.8 },
            { target: ".paris", vars: { opacity: 1 }, position: 0.8 },
            { target: ".paris__text", vars: { opacity: 1 }, position: 0.8 },
            {
                target: ".story__text1",
                vars: { opacity: 1 },
                position: 1,
            ...
            { target: ".party1", vars: { opacity: 1 }, position: 2 },
            { target: ".glass1", vars: { opacity: 1 }, position: 2 },
            { target: ".glass2", vars: { opacity: 1 }, position: 2 },
            { target: ".party2", vars: { opacity: 1 }, position: 2.3 },
            { target: ".cheers", vars: { opacity: 1 }, position: 2.3 },
            { target: ".yellowstar", vars: { opacity: 1 }, position: 2.3 },
            { target: ".glass1", vars: { rotate: "30deg" }, position: 2.3 },
            { target: ".glass2", vars: { rotate: "150deg" }, position: 2.3 },
            { target: ".star", vars: { opacity:1 }, position: 2.3 },
            { target: ".party3", vars: { opacity: 1 }, position: 2.6 },
            {
                target: ".story__text2",
                vars: { opacity: 1 },
                position: 2.9,
            ...
            { target: ".vroom1", vars: { opacity:1 }, position: 3.9 },
            { target: ".cyclist", vars: { top:"0vh", left:"0vw" }, position: 4.2 },
            { target: ".vroom2", vars: { opacity: 1 }, position: 4.2 },
            { target: ".cyclist", vars: { top: "-10vh", left: "-10vw" }, position: 4.5 },
            { target: ".vroom3", vars: { opacity: 1 }, position: 4.5 },
            {
                target: ".story__text3",
                vars: { opacity: 1 },
                position: 4.6,
