...
export const setupScrollAnimations = () => {
    ...
    pinAndAnimate({
        ...
        animations: [
            ...
            { target: ".bling1", vars: { opacity: 1 }, position: 0.5 },
            { target: ".bling2", vars: { opacity: 1 }, position: 1 },
            { target: ".bling3", vars: { opacity: 1 }, position: 1.5 },
            {
                target: ".story__text1",
                vars: { opacity: 1 },
                position: 1.8,
            ...
            { target: ".rectangle", vars: { opacity: 1 }, position: 3.4 },
            ...
            { target: ".circle", vars: { opacity: 1 }, position: 4.5 },
