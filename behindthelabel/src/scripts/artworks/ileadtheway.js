...
export const setupScrollAnimations = () => {
    ...
    pinAndAnimate({
        ...
        animations: [
            ...
            { target: ".anniversary", vars: { opacity: 1 }, position: 0.3 },
            { target: ".yellowstar", vars: { opacity: 1 }, position: 0.8 },
            { target: ".star", vars: { opacity: 1 }, position: 0.8 },
            {
                target: ".story__text1",
                vars: { opacity: 1 },
                position: 1,
            ...
            { target: ".pop1", vars: { opacity: 1, fontSize: "2rem" }, position: 2.2 },
            { target: ".pop2", vars: { opacity: 1, fontSize: "2rem" }, position: 3 },
            { target: ".pop3", vars: { opacity: 1, fontSize: "2rem" }, position: 2.6 },
            { target: ".pop4", vars: { opacity: 1, fontSize: "2rem" }, position: 3.4 },
            {
                target: ".story__text2",
                vars: { opacity: 1 },
                position: 3.5,
            ...
            { target: ".break", vars: { opacity: 1 }, position: 4.6 },
            { target: ".fear", vars: { opacity: 1 }, position: 4.6 },
            { target: ".bigstar1", vars: { scale: 1.2, opacity: 1 }, position: 5 },
            { target: ".bigstar2", vars: { scale: 1, opacity: 1 }, position: 5 },
            {
                target: ".story__text3",
                vars: { opacity: 1 },
                position: 5.1,
